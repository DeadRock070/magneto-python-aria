...
```
- Special thanks to [Yash Babu](https://github.com/DeadRock070) for very much useful feature **Unzipmirror**
- Features added from [Yash Babu's](https://github.com/DeadRock070) repo
```
1. unzipmirror
